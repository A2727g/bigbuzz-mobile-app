...
part of 'campaign_auditor.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CampaignAuditor _$CampaignAuditorFromJson(Map<String, dynamic> json) =>
    CampaignAuditor(
      json['campaign_auditor_id'] as String,
      json['campaign_id'] as String,
      json['client_id'] as String,
      json['auditor_id'] as String,
...
Map<String, dynamic> _$CampaignAuditorToJson(CampaignAuditor instance) =>
    <String, dynamic>{
      'campaign_auditor_id': instance.campaign_auditor_id,
